const brnAdicionarTarefa = document.querySelector('.app__button--add-task');
...
brnAdicionarTarefa.addEventListener('click', () => {
...
document.addEventListener('FocoFinalizado', () => {
    if(tarefaSelecionada && litarefaSelecionada) {
        litarefaSelecionada.classList.remove('bntRemoverConcluidas');
